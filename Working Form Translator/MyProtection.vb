...
Imports DynamicComponents.FormTranslator
...
Namespace DynamicComponents
    Public Class MyProtection
        ...
        Private ProductNum As String = "18"
...
#End If
            ...
            AuthorButton2.Location = New System.Drawing.Point(295, 310)
...
Re_Connect:
        ...
        Private Sub AuthorBuyNow_LinkClicked(ByVal sender As Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs)
            Dim buyURL
            buyURL = regGetBuyURL("EgyFirst Software", "DC Form Translator", "3.5")
