...
Partial Public Class nWindDataSet
    ...
    Partial Public Class OrderDetailsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddOrderDetailsRow(ByVal OrderID As String, ByVal ProductID As String, ByVal ProductName As String, ByVal UnitPrice As Decimal, ByVal Quantity As Short, ByVal Discount As Single) As OrderDetailsRow
            Dim rowOrderDetailsRow As OrderDetailsRow = CType(Me.NewRow,OrderDetailsRow)
            Dim columnValuesArray() As Object = New Object() {OrderID, ProductID, ProductName, UnitPrice, Quantity, Discount}
        ...
        Private Sub InitClass()
            ...
            Me.columnProductID.MaxLength = 2
...
Namespace nWindDataSetTableAdapters
    ...
    Partial Public Class OrderDetailsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `OrderDetails` (`OrderID`, `ProductID`, `ProductName`, `UnitPrice`, `"& _ 
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.My.MySettings.Default.nWindConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT OrderID, ProductID, ProductName, UnitPrice, Quantity, Discount FROM OrderD"& _ 
                "etails"
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As nWindDataSet.OrderDetailsDataTable) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal OrderID As String, ByVal ProductID As String, ByVal ProductName As String, ByVal UnitPrice As Decimal, ByVal Quantity As Short, ByVal Discount As Single) As Integer
            ...
            Me.Adapter.InsertCommand.Parameters(4).Value = CType(Quantity,Short)
            Me.Adapter.InsertCommand.Parameters(5).Value = CType(Discount,Single)
